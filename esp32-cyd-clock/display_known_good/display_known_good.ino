// display_known_good -- the verified-correct display stack for the
// ESP32-2432S028 dual-USB CYD, physically confirmed (not just Serial-
// log-confirmed) to fill the entire 320x240 landscape panel with no
// crop/wrap/offset/mirroring. Preserved verbatim (not edited/optimized
// further) as the reference example per DISPLAY_DRIVER_MATRIX.md and
// BOARD_INFO.md. Build with ./build_and_flash.sh [--flash].
//

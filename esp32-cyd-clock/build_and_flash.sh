#!/bin/bash
# esp32-cyd-clock build -- TFT_eSPI configured entirely via compiler
# defines (compiler.cpp.extra_flags), NOT by editing the shared
# installed library's User_Setup.h. See display.h and BOARD_INFO.md.
#
